...
/* ============================================================
   Card — surface container with optional bleed art / elevation
   ============================================================ */
function Card({ children, elevation = 1, padded = true, interactive = false, className = '', style = {}, ...props }) {
...
/* ============================================================
   Badge / Pill
   tones: default | accent | positive | negative | warn
   ============================================================ */
function Badge({ tone = 'default', children, dot = false, mono = false, style = {}, ...props }) {
  const tones = {
...
/* ============================================================
   Input
   ============================================================ */
function Input({ label, hint, error, iconLeft, iconRight, id, ...props }) {
...
/* ============================================================
   ...
   ============================================================ */
function Tabs({ value, onChange, items, fullWidth = false }) {
...
/* ============================================================
   ...
   ============================================================ */
function Slider({ value, onChange, min = 0, max = 100, step = 1, label, format = (v) => v, showTicks = false, marks = [] }) {
...
/* ============================================================
   Section heading
   ============================================================ */
function SectionHeading({ eyebrow, title, subtitle, align = 'left', maxWidth = 720 }) {
  return (
...
/* ============================================================
   Icon set — clean stroke icons (no AI-slop SVGs)
   ============================================================ */
...
/* ============================================================
   Tooltip (lightweight — appears under target)
   ============================================================ */
...
spinKeyframes.innerHTML = '@keyframes spin { to { transform: rotate(360deg); } }';
document.head.appendChild(spinKeyframes);

/* expose to window so other Babel scripts can use these */
Object.assign(window, {
  Button, Spinner, Card, Badge, Input, Tabs, Slider, SectionHeading, Tooltip, Icon,
});
