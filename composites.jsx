/* Tesla — composite components
   Sparkline + AreaChart + LineChart, MarketTicker, Command Palette,
   Logo, NavBar, ProgressMeter, KeyHint */

/* ============================================================
   Logo — sun-burst mark + wordmark (original)
   ============================================================ */
...
/* ============================================================
   Key hint — ⌘K-style key cap
   ============================================================ */
function KeyHint({ keys = ['⌘', 'K'] }) {
  return (
...
/* ============================================================
   Sparkline — for ticker rows + cards
   ============================================================ */
function Sparkline({ data, width = 80, height = 24, color = 'var(--text-2)', fill = false, animate = true }) {
...
/* ============================================================
   AreaChart — main hero/dashboard chart with crosshair on hover
   ============================================================ */
function AreaChart({ data, height = 240, color = 'var(--accent)', label = 'Portfolio', showAxis = true, showGrid = true }) {
...
/* ============================================================
   Candlestick — used in dashboard preview
   ============================================================ */
function Candlestick({ candles, height = 180 }) {
  const ref = React.useRef(null);
  const [w, setW] = React.useState(600);
  React.useLayoutEffect(() => {
    if (!ref.current) return;
...
/* ============================================================
   Market Ticker — animated marquee with simulated live data
   ============================================================ */
...
/* ============================================================
   Command Palette (⌘K) — accessible, keyboard-driven
   ============================================================ */
function CommandPalette({ open, onClose }) {
  ...
  React.useEffect(() => { if (open) { setQ(''); setActive(0); setTimeout(() => inputRef.current?.focus(), 50); } }, [open]);
    ...
    >
      ...
      >
        ...
        <div style={{
          ...
          <span style={{ display: 'inline-flex', alignItems: 'center', gap: 6 }}>Powered by Tesla <KeyHint keys={['⌘', 'K']} /></span>
        </div>
      </div>
    </div>
  );
...
Object.assign(window, { Logo, KeyHint, Sparkline, AreaChart, Candlestick, MarketTicker, CommandPalette });
